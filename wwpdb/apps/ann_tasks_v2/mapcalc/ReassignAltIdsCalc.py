...
class ReassignAltIdsCalc(SessionWebDownloadUtils):
    """
     The ReassignAltIdsCalc class launches dcc/tool to reassign alt ids ...

    """
    def __init__(self,reqObj=None,verbose=False,log=sys.stderr):
        super(ReassignAltIdsCalc,self).__init__(reqObj=reqObj,verbose=verbose,log=log)
    ...
    def run(self,entryId,modelInputFile=None,expInputFile=None,updateInput=True): 
        ...
        try:
            ...
            if expInputFile is None:
                ...
                sfPath=os.path.join(self.__sessionPath,expInputName)
            else:
            ...
            dp.op("annot-dcc-reassign-alt-ids")
            dp.expLog(logPath)
            dp.exp(retPath)
