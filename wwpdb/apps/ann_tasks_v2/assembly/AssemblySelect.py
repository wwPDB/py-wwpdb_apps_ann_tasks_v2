...
class AssemblySelect(object):
    ...
    def getLaunchJmolHtml(self, assemblyUid, entryId, generated=False):
        ...
        if generated:
            ...
            setupCmds = setupCmds = " select *; background white; wireframe off; ribbons off; cartoons on; labels off; spacefill off; color property modelindex; select ligands; spacefill on; slab 100; depth 10; slab on; "
        else:
        ...
        # width="98%">')
        htmlL.append(
            '<applet name="jmolApplet0" id="jmolApplet0" code="JmolApplet" archive="JmolAppletSigned0.jar" codebase="/applets/jmol-latest/jsmol/java" mayscript="true" height="98%" width="98%">')
